        ...
        return (
          <>
            ...
            <Menu.Item
              name="Logout"
              href="/api/logout"
              active={this.state.activeItem === "Logoute"}
              onClick={this.handleItemClick}
              key="3"
            />
          </>
    ...
    return (
      <>
        <Menu text className="header-1">
          <Link to="/">
            <img style={{ "max-width": "80px" }} src={leafImage} />
          </Link>
          <Menu.Item
            name="Oak Leaf Store"
            href="/"
        ...
        <Menu text className="header-2">
          <Dropdown item text="Plants" className="nav-item">
            <Dropdown.Menu>
              <Dropdown.Item>All Plants</Dropdown.Item>
              <Dropdown.Item>Tropical Indoor Plants</Dropdown.Item>
              <Dropdown.Item>Succulents &amp; Cacti</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
          <Menu.Item
            name="About Us"
